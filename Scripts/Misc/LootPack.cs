...
namespace Server
{
	public class LootPack
	{
		...
		public static readonly LootPack OldPoor = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,			100.00, "2d25" ),
				new LootPackEntry( false, Instruments,	  0.02, 1 )
			} );
		...
		public static readonly LootPack OldAverage = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,			100.00, "20d10+25" ),
				new LootPackEntry( false, Instruments,	  0.40, 1 ),
				new LootPackEntry( false, MagicItems,	  3, 1, 1, 20, 80 ),
		...
		public static readonly LootPack OldRich = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,			100.00, "20d10+120" ),
				new LootPackEntry( false, Instruments,	  1.00, 1 ),
				new LootPackEntry( false, MagicItems,	 8, 1, 1, 60, 100 ),
				new LootPackEntry( false, MagicItems,	 5, 1, 1, 65, 100 ),
				new LootPackEntry( false, MagicItems,	  1, 1, 1, 70, 100 )
			} );

		public static readonly LootPack OldFilthyRich = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,			100.00, "14d100+160" ),
				new LootPackEntry( false, Instruments,	  2.00, 1 ),
				new LootPackEntry( false, MagicItems,	 15, 1, 1, 50, 100 ),
				new LootPackEntry( false, MagicItems,	 9, 1, 1, 60, 100 ),
				new LootPackEntry( false, MagicItems,	 8, 1, 1, 70, 100 ),
		...
		public static readonly LootPack OldUltraRich = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,			100.00, "20d100+165" ),
				new LootPackEntry( false, Instruments,	  2.00, 1 ),
				new LootPackEntry( false, MagicItems,	22, 1, 1, 40, 100 ),
				new LootPackEntry( false, MagicItems,	17, 1, 1, 40, 100 ),
				new LootPackEntry( false, MagicItems,	15, 1, 1, 50, 100 ),
				new LootPackEntry( false, MagicItems,	8, 1, 1, 50, 100 ),
				new LootPackEntry( false, MagicItems,	7, 1, 1, 60, 100 ),
				new LootPackEntry( false, MagicItems,	5, 1, 1, 60, 100 )
			} );

		public static readonly LootPack OldSuperBoss = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,			100.00, "40d100+190" ),
				new LootPackEntry( false, Instruments,	  2.00, 1 ),
				new LootPackEntry( false, MagicItems,	30, 1, 1, 40, 100 ),
				new LootPackEntry( false, MagicItems,	27, 1, 1, 40, 100 ),
				new LootPackEntry( false, MagicItems,	20, 1, 1, 40, 100 ),
				new LootPackEntry( false, MagicItems,	17, 1, 1, 50, 100 ),
				new LootPackEntry( false, MagicItems,	13, 1, 1, 50, 100 ),
				new LootPackEntry( false, MagicItems,	11, 1, 1, 50, 100 ),
				new LootPackEntry( false, MagicItems,	10, 1, 1, 60, 100 ),
				new LootPackEntry( false, MagicItems,	9, 1, 1, 60, 100 ),
				new LootPackEntry( false, MagicItems,	8, 1, 1, 60, 100 ),
				new LootPackEntry( false, MagicItems,	5, 1, 1, 70, 100 )
			} );
		#endregion
		...
		public static readonly LootPack MedScrolls = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry( false, MedScrollItems,	80, 1 )
			} );

		public static readonly LootPack HighScrolls = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry( false, HighScrollItems,	80, 1 )
			} );
		...
		public static readonly LootPack Potions = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry( false, PotionItems,		80, 1 )
			} );
	}
