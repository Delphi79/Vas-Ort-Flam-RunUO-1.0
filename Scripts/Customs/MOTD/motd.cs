...
namespace Xanthos.Motd
{
	public class NewsGump : Gump
	{
		...
		private const string kGreeting = "Greetings And Welcome To Vas Ort Flam";
		...
		public static void Initialize()
		{
            ...
            Server.Commands.Register( "MOTD", AccessLevel.Administrator, new CommandEventHandler( MOTD_OnCommand ) );
		}
