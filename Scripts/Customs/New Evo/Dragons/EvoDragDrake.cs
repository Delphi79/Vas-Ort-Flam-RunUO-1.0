...
namespace Server.Mobiles
{
	...
	public class EvoDragDrake : BaseDragon
	{
		//	public override bool IsEvo { get { return true; } }
		
		[Constructable]
		public EvoDragDrake () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ControlSlots = 3;
			MinTameSkill = 93.9;
		...
		public EvoDragDrake( Serial serial ) : base( serial )
		{
		}
		...
		public override void Evolve()
		{
			...
			EvoDragDrag EL = new EvoDragDrag();
			New(EL);
