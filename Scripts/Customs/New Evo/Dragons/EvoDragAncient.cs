...
namespace Server.Mobiles
{
	...
	public class EvoDragAncie : BaseDragon
	{
		//	public override bool IsEvo { get { return true; } }
		
		[Constructable]
		public EvoDragAncie () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ControlSlots = 4;
			MinTameSkill = 93.9;
		...
		public EvoDragAncie( Serial serial ) : base( serial )
		{
		}
		...
		public override void Evolve()
		{
			...
			EvoDragGreat EL = new EvoDragGreat();
			New(EL);
