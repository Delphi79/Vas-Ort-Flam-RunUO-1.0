...
namespace Server.Mobiles
{
	...
	public class EvoDragGreat : BaseDragon
	{
		//	public override bool IsEvo { get { return true; } }
		
		[Constructable]
		public EvoDragGreat () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ControlSlots = 4;
			MinTameSkill = 93.9;
		...
		public EvoDragGreat( Serial serial ) : base( serial )
		{
		}
