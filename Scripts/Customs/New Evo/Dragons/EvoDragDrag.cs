...
namespace Server.Mobiles
{
	...
	public class EvoDragDrag : BaseDragon
	{
		//	public override bool IsEvo { get { return true; } }
		
		[Constructable]
		public EvoDragDrag () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ControlSlots = 3;
			MinTameSkill = 93.9;
		...
		public EvoDragDrag( Serial serial ) : base( serial )
		{
		}
		...
		public override void Evolve()
		{
			...
			EvoDragAncie EL = new EvoDragAncie();
			New(EL);
