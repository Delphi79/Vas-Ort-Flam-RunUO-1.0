...
namespace Server.Mobiles
{
	...
	public class EvoDragAli : BaseDragon
	{
		//	public override bool IsEvo { get { return true; } }
		
		[Constructable]
		public EvoDragAli () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ControlSlots = 2;
			MinTameSkill = 93.9;
		...
		public EvoDragAli( Serial serial ) : base( serial )
		{
		}
		...
		public override void Evolve()
		{
			...
			EvoDragLizard EL = new EvoDragLizard();
			New(EL);
