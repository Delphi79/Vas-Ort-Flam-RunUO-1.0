...
namespace Server.Mobiles
{
	...
	public class EvoDragLizard : BaseDragon
	{
		//	public override bool IsEvo { get { return true; } }

		[Constructable]
		public EvoDragLizard() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Body = 0xCE;
		...
		public EvoDragLizard(Serial serial) : base(serial)
		{
		}
		...
		public override void Evolve()
		{
			...
			EvoDragDrake EL = new EvoDragDrake();
			New(EL);
