...
namespace Server.Mobiles
{
	...
	public class EvoWWDrake : BaseWhiteWyrm
	{
		//	public override bool IsEvo { get { return true; } }
		
		[Constructable]
		public EvoWWDrake () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ControlSlots = 3;
			MinTameSkill = 93.9;
		...
		public EvoWWDrake( Serial serial ) : base( serial )
		{
		}
