...
namespace Server.Mobiles
{
	...
	public class EvoWWDrag : BaseWhiteWyrm
	{
		//	public override bool IsEvo { get { return true; } }
		
		[Constructable]
		public EvoWWDrag () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ControlSlots = 3;
			MinTameSkill = 93.9;
		...
		public EvoWWDrag( Serial serial ) : base( serial )
		{
		}
