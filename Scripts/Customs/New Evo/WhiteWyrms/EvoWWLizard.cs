...
namespace Server.Mobiles
{
	...
	public class EvoWWLizard : BaseWhiteWyrm
	{
		//	public override bool IsEvo { get { return true; } }

		[Constructable]
		public EvoWWLizard() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Body = 0xCE;
...
// Max Stats
		...
		public EvoWWLizard(Serial serial) : base(serial)
		{
		}
