...
namespace Server.Mobiles
{
	...
	public class EvoWWSnake : BaseWhiteWyrm
	{
		//	public override bool IsEvo { get { return true; } }
		
		[Constructable]
		public EvoWWSnake () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ControlSlots = 1;
			MinTameSkill = 93.9;
		...
		public EvoWWSnake( Serial serial ) : base( serial )
		{
		}
