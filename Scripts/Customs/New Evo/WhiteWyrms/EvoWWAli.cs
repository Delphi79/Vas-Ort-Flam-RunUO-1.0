...
namespace Server.Mobiles
{
	...
	public class EvoWWAli : BaseWhiteWyrm
	{
		//	public override bool IsEvo { get { return true; } }
		
		[Constructable]
		public EvoWWAli () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ControlSlots = 2;
			MinTameSkill = 93.9;
		...
		public EvoWWAli( Serial serial ) : base( serial )
		{
		}
		...
		public override void Evolve()
		{
			...
			EvoWWLizard EL = new EvoWWLizard();
			New(EL);
