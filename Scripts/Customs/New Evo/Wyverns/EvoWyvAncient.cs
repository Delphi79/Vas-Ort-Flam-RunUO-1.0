...
namespace Server.Mobiles
{
	...
	public class EvoWyvAncie : BaseWyvern
	{
		//	public override bool IsEvo { get { return true; } }
		
		[Constructable]
		public EvoWyvAncie () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ControlSlots = 4;
			MinTameSkill = 93.9;
		...
		public EvoWyvAncie( Serial serial ) : base( serial )
		{
		}
		...
		public override void Evolve()
		{
			...
			EvoWyvGreat EL = new EvoWyvGreat();
			New(EL);
