...
namespace Server.Mobiles
{
	...
	public class EvoWyvSerp : BaseWyvern
	{
		//	public override bool IsEvo { get { return true; } }
		
		[Constructable]
		public EvoWyvSerp () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ControlSlots = 1;
			MinTameSkill = 93.9;
		...
		public EvoWyvSerp( Serial serial ) : base( serial )
		{
		}
