...
namespace Server.Items
{
	...
	public class PlayerScoreBoard : BaseScoreBoard
	{
		...
		[Constructable]
		public PlayerScoreBoard( ) : base( 0x1E5E )
		{
			
		}
		
		public PlayerScoreBoard( Serial serial ) : base( serial )
		{
		}
	...
	public abstract class BaseScoreBoard : Item
	{
		...
		public BaseScoreBoard( int itemID ) : base( itemID )
		{
		...
		public BaseScoreBoard( Serial serial ) : base( serial )
		{
		}
