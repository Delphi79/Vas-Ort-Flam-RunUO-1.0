...
namespace Server.ChallengeSpeech
{
	public class ChallengeOnSpeech
	{
		...
		private static void EventSink_Speech( SpeechEventArgs args )
		{
			...
			if (args.Speech.ToLower() == "duelpoints")
				pm.PublicOverheadMessage(MessageType.Regular, pm.SpeechHue, true, pm.Wins + @"/" + pm.Loses); // NOTE: Added 'N0'
