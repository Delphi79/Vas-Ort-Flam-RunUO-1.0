...
namespace Server.Gumps
{
	public class OnlineGump : Gump
	{
		...
		{
			Commands.Register( "On", AccessLevel.Player, new CommandEventHandler( Online_OnCommand ) );
			Commands.Register( "Online", AccessLevel.Player, new CommandEventHandler( Online_OnCommand ) );
		}
