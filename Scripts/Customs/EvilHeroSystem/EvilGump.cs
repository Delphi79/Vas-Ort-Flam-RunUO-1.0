...
namespace Server.Gumps
{
	public class EvilGump : Gump
	{
			...
			: base( 0, 0 )
		{
			...
			this.AddLabel(94, 76, 1152, @"Black Armor");
			this.AddLabel(95, 117, 1152, @"Detect Good");
			this.AddLabel(106, 192, 1152, @"Summon");
			this.AddLabel(106, 207, 1152, @"Familiar");
			this.AddLabel(110, 233, 1152, @"Unholy");
			this.AddLabel(112, 249, 1152, @"Steed");
			this.AddLabel(114, 281, 1152, @"Blight");
			this.AddLabel(107, 314, 1152, @"Monster");
			this.AddLabel(114, 330, 1152, @"Ignore");
			this.AddLabel(110, 354, 1152, @"Unholy");
			this.AddLabel(113, 370, 1152, @"Word");
			this.AddLabel(104, 158, 1152, @"Vile Blade");
			this.AddLabel(193, 76, 149, @"Vidda K'blac");
			this.AddLabel(184, 117, 149, @"Drewrok Erstok");
			this.AddLabel(184, 157, 149, @"Trubechs Vingir");
			this.AddLabel(190, 199, 149, @"Velgo Reyam");
			this.AddLabel(182, 242, 149, @"Trubechs Yeliab");
			this.AddLabel(193, 281, 149, @"Velgo Ontawl");
			this.AddLabel(195, 322, 149, @"Velgo K'balc");
			this.AddLabel(189, 361, 149, @"Velgo Oostrac");
			this.AddLabel(298, 64, 1152, @"Invoking this power turns equipment true ");
			this.AddLabel(298, 77, 1152, @"black. When unequipped, the item returns");
			this.AddLabel(298, 89, 1152, @"to its natural color.");
			this.AddLabel(589, 76, 149, @"1");
			this.AddLabel(657, 76, 92, @"1");
			this.AddLabel(297, 110, 1152, @"This power returns information on the ");
			this.AddLabel(298, 123, 1152, @"proximity of heroes.");
			this.AddLabel(297, 192, 1152, @"This conjures up a black wolf to serve");
			this.AddLabel(298, 207, 1152, @"as a pet for a period of time.");
			this.AddLabel(298, 151, 1152, @"Gives the selected weapon a few lethal ");
			this.AddLabel(299, 165, 1152, @"charges of poison.");
			this.AddLabel(296, 233, 1152, @"This conjures up a mystical black steed");
			this.AddLabel(297, 247, 1152, @"to serve as the your mount.");
			this.AddLabel(297, 274, 1152, @"This targetable area effect power causes");
			this.AddLabel(297, 288, 1152, @"damage to all heroes in the range.");
			this.AddLabel(296, 314, 1152, @"This ability makes even aggressive");
			this.AddLabel(296, 327, 1152, @"monsters ignore you.");
			this.AddLabel(296, 350, 1152, @"This allows you to target a hero and simply ");
