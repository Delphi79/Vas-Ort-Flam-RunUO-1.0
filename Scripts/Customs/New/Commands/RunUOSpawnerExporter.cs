...
namespace Server.Scripts.Commands
{
	public class RunUOSpawnerExporter
	{
		...
		{
			Server.Commands.Register( "RunUOSpawnerExporter" , AccessLevel.Administrator, new CommandEventHandler( RunUOSpawnerExporter_OnCommand ) );
			Server.Commands.Register( "RSE" , AccessLevel.Administrator, new CommandEventHandler( RunUOSpawnerExporter_OnCommand ) );
		}
