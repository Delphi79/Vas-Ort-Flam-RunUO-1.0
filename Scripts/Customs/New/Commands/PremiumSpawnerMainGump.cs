...
namespace Server.Scripts.Commands 
{
	public class PremiumSpawner
	{
		...
		{ 
			Server.Commands.Register( "PremiumSpawner", AccessLevel.Administrator, new CommandEventHandler( PremiumSpawner_OnCommand ) );
			Server.Commands.Register( "Spawner", AccessLevel.Administrator, new CommandEventHandler( PremiumSpawner_OnCommand ) ); 
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				case 10001:
				{
					...
					Commands.Handle( from, String.Format( "{0}createworld", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10002:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}spawn", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10003:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}spawnilshenar", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10004:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}spawnmalas", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10005:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}unload", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10006:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}unloadilshenar", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10007:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}unloadmalas", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10008:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}spawngen save", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10009:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}spawngen savebyhand", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10010:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}GumpSaveRegion", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10011:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}GumpSaveCoordinate", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10012:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}spawngen remove", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10013:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}spawnrem", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10014:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}GumpRemoveID", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10015:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}GumpRemoveCoordinate", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10016:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}GumpRemoveRegion", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10017:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}editor", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10018:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}clearall", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10019:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}gmbody", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10104:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}spawntokuno", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10107:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}unloadtokuno", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
				case 10108:
				{
					string prefix = Server.Commands.CommandPrefix;
					Commands.Handle( from, String.Format( "{0}rse", prefix ) );
					Commands.Handle( from, String.Format( "{0}spawner", prefix ) );
					break;
				}
			}
