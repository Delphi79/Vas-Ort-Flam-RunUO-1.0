...
namespace Server.Scripts.Commands 
{
	public class Spawn
	{
        ...
        { 
            Server.Commands.Register( "Spawn", AccessLevel.Administrator, new CommandEventHandler( SpawnMain_OnCommand ) );
	    Server.Commands.Register( "SpawnMalas", AccessLevel.Administrator, new CommandEventHandler( SpawnMalas_OnCommand ) );
	    Server.Commands.Register( "SpawnIlshenar", AccessLevel.Administrator, new CommandEventHandler( SpawnIlshenar_OnCommand ) );
	    Server.Commands.Register( "SpawnTokuno", AccessLevel.Administrator, new CommandEventHandler( SpawnTokuno_OnCommand ) );
        }
...
// Trammel -------------------
                        ...
                        if( Selections.Contains( 101 ) == true )
                        {
                            ...
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/animals.map", prefix ) );
                        }

                        if( Selections.Contains( 102 ) == true )
                        {
                            from.Say( "Spawning Camps arount the world..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/camps.map", prefix ) );
                        }

                        if( Selections.Contains( 103 ) == true )
                        {
                            from.Say( "Spawning Covetous dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/covetous.map", prefix ) );
                        }

                        if( Selections.Contains( 104 ) == true )
                        {
                            from.Say( "Spawning Deceit dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/deceit.map", prefix ) );
                        }

                        if( Selections.Contains( 105 ) == true )
                        {
                            from.Say( "Spawning Despise dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/despise.map", prefix ) );
                        }

                        if( Selections.Contains( 106 ) == true )
                        {
                            from.Say( "Spawning Destard dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/destard.map", prefix ) );
                        }

                        if( Selections.Contains( 107 ) == true )
                        {
                            from.Say( "Spawning escortables in some towns..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/escorts.map", prefix ) );
                        }

                        if( Selections.Contains( 108 ) == true )
                        {
                            from.Say( "Spawning Fire dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/fire.map", prefix ) );
                        }

                        if( Selections.Contains( 109 ) == true )
                        {
                            from.Say( "Spawning graveyards..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/graveyards.map", prefix ) );
                        }

                        if( Selections.Contains( 110 ) == true )
                        {
                            from.Say( "Spawning Hythloth dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/hythloth.map", prefix ) );
                        }

                        if( Selections.Contains( 111 ) == true )
                        {
                            from.Say( "Spawning Ice dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/ice.map", prefix ) );
                        }

                        if( Selections.Contains( 113 ) == true )
                        {
                            from.Say( "Spawning Lost Lands..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/lostlands.map", prefix ) );
                        }

                        if( Selections.Contains( 114 ) == true )
                        {
                            from.Say( "Spawning miscellaneous..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/miscellaneous.map", prefix ) );
                        }

                        if( Selections.Contains( 115 ) == true )
                        {
                            from.Say( "Spawning Moonglow Zoo..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/moonglowzoo.map", prefix ) );
                        }

                        if( Selections.Contains( 116 ) == true )
                        {
                            from.Say( "Spawning Orc Caves..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/orccaves.map", prefix ) );
                        }

                        if( Selections.Contains( 117 ) == true )
                        {
                            from.Say( "Spawning heavy spawns around the world..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/osiheavy.map", prefix ) );
                        }

                        if( Selections.Contains( 118 ) == true )
                        {
                            from.Say( "Spawning light spawns around the world..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/osilight.map", prefix ) );
                        }

                        if( Selections.Contains( 119 ) == true )
                        {
                            from.Say( "Spawning medium spawns around the world..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/osimedium.map", prefix ) );
                        }

                        if( Selections.Contains( 120 ) == true )
                        {
                            from.Say( "Spawning Shame dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/shame.map", prefix ) );
                        }

                        if( Selections.Contains( 121 ) == true )
                        {
                            from.Say( "Spawning Solen Hive dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/solenhive.map", prefix ) );
                        }

                        if( Selections.Contains( 122 ) == true )
                        {
                            from.Say( "Spawning Terathan Keep..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/terathankeep.map", prefix ) );
                        }

                        if( Selections.Contains( 123 ) == true )
                        {
                            from.Say( "Spawning Town Criers in some towns..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/towncriers.map", prefix ) );
                        }

                        if( Selections.Contains( 124 ) == true )
                        {
                            from.Say( "Spawning animals in towns..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/towns.map", prefix ) );
                        }

                        if( Selections.Contains( 125 ) == true )
                        {
                            from.Say( "Spawning Trinsic Passage..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/trinsicpassage.map", prefix ) );
                        }

                        if( Selections.Contains( 126 ) == true )
                        {
                            from.Say( "Spawning vendors..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/vendors.map", prefix ) );
                        }

                        if( Selections.Contains( 127 ) == true )
                        {
                            from.Say( "Spawning Wrong dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen trammel/wrong.map", prefix ) );
                        }
...
// Felucca -------------------
				...
				from.Say( "SPAWNING FELUCCA..." );
                        ...
                        {
                            from.Say( "Spawning animals around the world..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/animals.map", prefix ) );
                        }

                        if( Selections.Contains( 129 ) == true )
                        {
                            from.Say( "Spawning Camps arount the world..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/camps.map", prefix ) );
                        }

                        if( Selections.Contains( 130 ) == true )
                        {
                            from.Say( "Spawning Covetous dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/covetous.map", prefix ) );
                        }

                        if( Selections.Contains( 131 ) == true )
                        {
                            from.Say( "Spawning Deceit dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/deceit.map", prefix ) );
                        }

                        if( Selections.Contains( 132 ) == true )
                        {
                            from.Say( "Spawning Despise dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/despise.map", prefix ) );
                        }

                        if( Selections.Contains( 133 ) == true )
                        {
                            from.Say( "Spawning Destard dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/destard.map", prefix ) );
                        }

                        if( Selections.Contains( 134 ) == true )
                        {
                            from.Say( "Spawning escortables in some towns..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/escorts.map", prefix ) );
                        }

                        if( Selections.Contains( 135 ) == true )
                        {
                            from.Say( "Spawning Fire dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/fire.map", prefix ) );
                        }

                        if( Selections.Contains( 136 ) == true )
                        {
                            from.Say( "Spawning graveyards..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/graveyards.map", prefix ) );
                        }

                        if( Selections.Contains( 137 ) == true )
                        {
                            from.Say( "Spawning Hythloth dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/hythloth.map", prefix ) );
                        }

                        if( Selections.Contains( 138 ) == true )
                        {
                            from.Say( "Spawning Ice dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/ice.map", prefix ) );
                        }

                        if( Selections.Contains( 139 ) == true )
                        {
                            from.Say( "Spawning Khaldun dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/khaldun.map", prefix ) );
                        }

                        if( Selections.Contains( 140 ) == true )
                        {
                            from.Say( "Spawning Lost Lands..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/lostlands.map", prefix ) );
                        }

                        if( Selections.Contains( 141 ) == true )
                        {
                            from.Say( "Spawning miscellaneous..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/miscellaneous.map", prefix ) );
                        }

                        if( Selections.Contains( 142 ) == true )
                        {
                            from.Say( "Spawning Moonglow Zoo..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/moonglowzoo.map", prefix ) );
                        }

                        if( Selections.Contains( 143 ) == true )
                        {
                            from.Say( "Spawning Orc Caves..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/orccaves.map", prefix ) );
                        }

                        if( Selections.Contains( 144 ) == true )
                        {
                            from.Say( "Spawning heavy spawns areas around the world..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/osiheavy.map", prefix ) );
                        }

                        if( Selections.Contains( 145 ) == true )
                        {
                            from.Say( "Spawning light spawns around the world..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/osilight.map", prefix ) );
                        }

                        if( Selections.Contains( 146 ) == true )
                        {
                            from.Say( "Spawning medium spawns around the world..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/osimedium.map", prefix ) );
                        }

                        if( Selections.Contains( 147 ) == true )
                        {
                            from.Say( "Spawning Shame dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/shame.map", prefix ) );
                        }

                        if( Selections.Contains( 148 ) == true )
                        {
                            from.Say( "Spawning Solen Hive dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/solenhive.map", prefix ) );
                        }

                        if( Selections.Contains( 149 ) == true )
                        {
                            from.Say( "Spawning Terathan Keep..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/terathankeep.map", prefix ) );
                        }

                        if( Selections.Contains( 150 ) == true )
                        {
                            from.Say( "Spawning Town Criers in some towns..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/towncriers.map", prefix ) );
                        }

                        if( Selections.Contains( 151 ) == true )
                        {
                            from.Say( "Spawning animals in towns..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/towns.map", prefix ) );
                        }

                        if( Selections.Contains( 152 ) == true )
                        {
                            from.Say( "Spawning Trinsic Passage..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/trinsicpassage.map", prefix ) );
                        }

                        if( Selections.Contains( 153 ) == true )
                        {
                            from.Say( "Spawning vendors..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/vendors.map", prefix ) );
                        }

                        if( Selections.Contains( 154 ) == true )
                        {
                            from.Say( "Spawning Wrong dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen felucca/wrong.map", prefix ) );
                        }
                    }
			...
			string prefix = Server.Commands.CommandPrefix;
				...
				from.Say( "SPAWNING ILSHENAR..." );
                        ...
                        if( Selections.Contains( 101 ) == true )
                        {
                            ...
                            Commands.Handle( from, String.Format( "{0}Spawngen ilshenar/ancientlair.map", prefix ) );
                        }

                        if( Selections.Contains( 102 ) == true )
                        {
                            from.Say( "Spawning Ankh dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen ilshenar/ankh.map", prefix ) );
                        }

                        if( Selections.Contains( 103 ) == true )
                        {
                            from.Say( "Spawning Blood dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen ilshenar/blood.map", prefix ) );
                        }

                        if( Selections.Contains( 104 ) == true )
                        {
                            from.Say( "Spawning Exodus dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen ilshenar/exodus.map", prefix ) );
                        }

                        if( Selections.Contains( 105 ) == true )
                        {
                            from.Say( "Spawning Mushroom Cave..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen ilshenar/mushroom.map", prefix ) );
                        }

                        if( Selections.Contains( 106 ) == true )
                        {
                            from.Say( "Spawning Northeast sector..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen ilshenar/northeast.map", prefix ) );
                        }

                        if( Selections.Contains( 107 ) == true )
                        {
                            from.Say( "Spawning Northwest sector..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen ilshenar/northwest.map", prefix ) );
                        }

                        if( Selections.Contains( 108 ) == true )
                        {
                            from.Say( "Spawning Ratman Cave..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen ilshenar/ratmancave.map", prefix ) );
                        }

                        if( Selections.Contains( 109 ) == true )
                        {
                            from.Say( "Spawning Rock dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen ilshenar/rock.map", prefix ) );
                        }

                        if( Selections.Contains( 110 ) == true )
                        {
                            from.Say( "Spawning Sorcerers dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen ilshenar/sorcerers.map", prefix ) );
                        }

                        if( Selections.Contains( 111 ) == true )
                        {
                            from.Say( "Spawning Southeast sector..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen ilshenar/southeast.map", prefix ) );
                        }

                        if( Selections.Contains( 112 ) == true )
                        {
                            from.Say( "Spawning Southwest sector..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen ilshenar/southwest.map", prefix ) );
                        }

                        if( Selections.Contains( 113 ) == true )
                        {
                            from.Say( "Spawning Spectre dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen ilshenar/spectre.map", prefix ) );
                        }

                        if( Selections.Contains( 114 ) == true )
                        {
                            from.Say( "Spawning Towns..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen ilshenar/towns.map", prefix ) );
                        }

                        if( Selections.Contains( 115 ) == true )
                        {
                            from.Say( "Spawning Vendors..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen ilshenar/vendors.map", prefix ) );
                        }

                        if( Selections.Contains( 116 ) == true )
                        {
                            from.Say( "Spawning Wisp dungeon..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen ilshenar/wisp.map", prefix ) );
                        }
                    }
			...
			string prefix = Server.Commands.CommandPrefix;
				...
				from.Say( "SPAWNING MALAS..." );
                        ...
                        if( Selections.Contains( 101 ) == true )
                        {
                            ...
                            Commands.Handle( from, String.Format( "{0}Spawngen malas/doom.map", prefix ) );
                        }

                        if( Selections.Contains( 102 ) == true )
                        {
                            from.Say( "Spawning North Malas..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen malas/north.map", prefix ) );
                        }

                        if( Selections.Contains( 103 ) == true )
                        {
                            from.Say( "Spawning Orc Forts..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen malas/orcforts.map", prefix ) );
                        }

                        if( Selections.Contains( 104 ) == true )
                        {
                            from.Say( "Spawning South Malas..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen malas/south.map", prefix ) );
                        }

                        if( Selections.Contains( 105 ) == true )
                        {
                            from.Say( "Spawning Vendors..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen malas/vendors.map", prefix ) );
                        }
                    }
			...
			string prefix = Server.Commands.CommandPrefix;
				...
				from.Say( "SPAWNING TOKUNO..." );
                        ...
                        if( Selections.Contains( 101 ) == true )
                        {
                            ...
                            Commands.Handle( from, String.Format( "{0}Spawngen tokuno/animals.map", prefix ) );
                        }

                        if( Selections.Contains( 102 ) == true )
                        {
                            from.Say( "Spawning Fan Dancer's Dojo..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen tokuno/fandancersdojo.map", prefix ) );
                        }

                        if( Selections.Contains( 103 ) == true )
                        {
                            from.Say( "Spawning NPCs everywhere..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen tokuno/monsters.map", prefix ) );
                        }

                        if( Selections.Contains( 104 ) == true )
                        {
                            from.Say( "Spawning Vendors..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen tokuno/vendors.map", prefix ) );
                        }

                        if( Selections.Contains( 105 ) == true )
                        {
                            from.Say( "Spawning Yomutso Mines..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen tokuno/yomutsomines.map", prefix ) );
                        }

                        if( Selections.Contains( 106 ) == true )
                        {
                            from.Say( "Spawning the town of Zento..." );
                            Commands.Handle( from, String.Format( "{0}Spawngen tokuno/zento.map", prefix ) );
                        }
                   }
