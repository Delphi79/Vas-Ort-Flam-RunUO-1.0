...
namespace Server.Gumps
{
	public class SpawnEditorGump : Gump
	{
		...
		{
			Commands.Register( "SpawnEditor", AccessLevel.GameMaster, new CommandEventHandler( SpawnEditor_OnCommand ) );
			Commands.Register( "Editor", AccessLevel.GameMaster, new CommandEventHandler( SpawnEditor_OnCommand ) );
		}
