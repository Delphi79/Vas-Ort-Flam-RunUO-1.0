...
{
	[CorpseName( "an elf boss corpse" )]
	public class ElvenKing : BaseCreature
	{


		[Constructable]
		public ElvenKing () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Lord Legalas the Elven King";
			Body = 175;
			Hue = 1154;
		...
		public ElvenKing( Serial serial ) : base( serial )
		{
		}
