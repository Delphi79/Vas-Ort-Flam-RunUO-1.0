...
{
    [CorpseName(" corpse of a spectral abomination")]
    public class aspectralabomination : BogThing
    {
        [Constructable]
        public aspectralabomination()
            : base()
        {
            Name = "a spectral abomination";
            Hue = 16667;
            SetStr(600);
            SetDex(200);
            SetInt(250);
        ...
        public aspectralabomination(Serial serial)
            : base(serial)
        {
        }
