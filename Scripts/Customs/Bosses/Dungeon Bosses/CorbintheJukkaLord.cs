...
{
    [CorpseName(" corpse of Corbin the Juka Commander")]
    public class CorbintheJukkaLord : JukaMage
    {
        [Constructable]
        public CorbintheJukkaLord()
            : base()
        {
            Name = "Corbin the Juka Commander";
            Hue = 2129;
            SetStr(300);
            SetDex(250);
            SetInt(225);
        ...
        public CorbintheJukkaLord(Serial serial)
            : base(serial)
        {
        }
