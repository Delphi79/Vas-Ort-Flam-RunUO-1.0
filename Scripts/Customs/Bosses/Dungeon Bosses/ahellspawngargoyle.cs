...
{
    [CorpseName(" corpse of a hellspawn gargoyle")]
    public class ahellspawngargoyle : Gargoyle
    {
        [Constructable]
        public ahellspawngargoyle()
            : base()
        {
            Name = "a hellspawn gargoyle";
            Hue = 1908;
            SetStr(350);
            SetDex(200);
            SetInt(225);
        ...
        public ahellspawngargoyle(Serial serial)
            : base(serial)
        {
        }
