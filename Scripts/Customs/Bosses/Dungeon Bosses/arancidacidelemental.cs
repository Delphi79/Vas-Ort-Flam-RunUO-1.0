...
{
    [CorpseName(" corpse of a rancid acid elemental")]
    public class arancidacidelemental : BogThing
    {
        [Constructable]
        public arancidacidelemental()
            : base()
        {
            Name = "a rancid acid elemental";
            Hue = 4001;
			Body = 787;
            SetStr(450);
            SetDex(200);
        ...
        public arancidacidelemental(Serial serial)
            : base(serial)
        {
        }
