...
{
    [CorpseName(" corpse of a rotting nightmare")]
    public class arottingnightmare : HellSteed
    {
        [Constructable]
        public arottingnightmare()
            : base()
        {
            Name = "a rotting nightmare";
            Hue = 2106;
            SetStr(500);
            SetDex(200);
            SetInt(225);
        ...
        public override void GenerateLoot()
        {
            if (Utility.Random(100) < 20)
            {
                ...
                lantern.Hue = Utility.RandomMinMax(2101, 2106);
                PackItem(lantern);
            }
        ...
        public arottingnightmare(Serial serial)  : base(serial)
        {
        }
