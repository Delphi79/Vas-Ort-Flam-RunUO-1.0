...
{
    [CorpseName(" corpse of a satan's offspring")]
    public class satansoffspring : Balron
    {
        [Constructable]
        public satansoffspring()
            : base()
        {
            Name = "satan's offspring";
			Body = 784;
            SetStr(400);
            SetDex(200);
            SetInt(225);
        ...
        public satansoffspring(Serial serial)
            : base(serial)
        {
        }
