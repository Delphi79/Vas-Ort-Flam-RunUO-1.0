...
{
	[CorpseName(" corpse of a darkness balron")]
	public class DarknessBalron : Balron
	{
		[Constructable]
		public DarknessBalron()
			: base()
		{
			Name = "a darkness balron";
			Hue = 01;
			SetStr(200);
			SetDex(100);
			SetInt(1000);
		...
		public DarknessBalron(Serial serial)
			: base(serial)
		{
