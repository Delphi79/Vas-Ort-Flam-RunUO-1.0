	...
	public class SBAlchemist : SBInfo
	{
		...
		public class InternalBuyInfo : ArrayList
		{
			...
			{  
				...
				Add( new GenericBuyInfo( "1041060", typeof( HairDye ), 37, 20, 0xEFF, 0 ) );
				Add( new GenericBuyInfo( typeof( HeatingStand ), 2, 20, 0x1849, 0 ) ); 
				...
				Add( new GenericBuyInfo( typeof( LesserExplosionPotion ), 20, 10, 0xF0D, 0 ) );
