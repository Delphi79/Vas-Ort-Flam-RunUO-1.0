...
namespace Server.Engines.Help
{
	...
	public class PageQueue
	{
		...
		{
			Server.Admin.AdminNetwork.Distribute( new Server.Admin.HandlePage( entry, value ) );
		...
		{
			Server.Admin.AdminNetwork.Distribute( AdminNetwork.Compress( new Server.Admin.NewPage( entry ) ) );
